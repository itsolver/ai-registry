...
- Renamed the public IT Solver auto-close replay surface to ITS Eval, made `/its-eval` canonical, and kept `/its` plus `includeItsBenchmark=false` as backwards-compatible aliases.
